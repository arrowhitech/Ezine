...
@implementation LastestOfSource
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    NSArray *array = [dictionary objectForKey:@"ListArticle"];
	return [array count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSDictionary *dictionary = [self.listLastest objectAtIndex:indexPath.section];
    NSArray *array = [dictionary objectForKey:@"ListArticle"];
    NSDictionary *dataArticle=[array objectAtIndex:indexPath.row];
    [cell setData:dataArticle];
    return cell;
