...
@implementation FacebookViewArticle2
...
- (void) initializeFields {
    ...
    [nameActor setTextColor:RGBCOLOR(95,95,95)];
    ...
    if (interfaceOrientation ==UIInterfaceOrientationPortrait||interfaceOrientation==UIInterfaceOrientationPortraitUpsideDown) {
        ...
        switch (self._type) {
            ...
            default:
                ...
                [nameActor sizeToFit];
                [time_ago setFrame:CGRectMake(nameActor.frame.origin.x,nameActor.frame.origin.y+nameActor.frame.size.height+2,contentViewArea.width , 20)];
                [imageView setFrame:CGRectMake(20,time_ago.frame.size.height+time_ago.frame.origin.y,10,10)];
