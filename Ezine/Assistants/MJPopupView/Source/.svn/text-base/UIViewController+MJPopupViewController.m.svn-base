...
- (void)presentPopupView2:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType;
...
- (void)presentPopupViewInParent:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType;
-(UIView *)topViewParent;
@end
...
-(void)presentPopupViewController2:(UIViewController *)popupViewController animationType:(MJPopupViewAnimation)animationType{
    [self presentPopupView2:popupViewController.view animationType:animationType];
}
...
- (void)presentPopupViewControllerParent:(UIViewController*)popupViewController animationType:(MJPopupViewAnimation)animationType{
    ...
    [self presentPopupViewInParent:popupViewController.view animationType:animationType];
}
#pragma mark======Ok=====End Try=======


- (void)dismissPopupViewControllerWithanimationType:(MJPopupViewAnimation)animationType
{
    NSLog(@"dismissPopupViewControllerWithanimationType");
...
- (void)dismissPopupViewControllerWithanimationTypeInParent:(MJPopupViewAnimation)animationType{
    NSLog(@"dismissPopupViewControllerWithanimationTypeInParent");
    UIView *sourceView = [self topViewParent];
    UIView *popupView = [sourceView viewWithTag:kMJPopupViewTag];
    UIView *overlayView = [sourceView viewWithTag:kMJOverlayViewTag];
...
- (void)presentPopupViewInParent:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType
{
    ...
    [dismissButton addTarget:self action:@selector(dismissPopupViewControllerWithanimationInParent:) forControlEvents:UIControlEventTouchUpInside];
    switch (animationType) {
        case MJPopupViewAnimationSlideBottomTop:
        case MJPopupViewAnimationSlideBottomBottom:
        case MJPopupViewAnimationSlideRightLeft:
...
-(UIView*)topViewParent{
    ...
    while (recentView.parentViewController.parentViewController.parentViewController.parentViewController != nil) {
        recentView = recentView.parentViewController.parentViewController.parentViewController.parentViewController;
    }
    return recentView.view;
...
- (void)dismissPopupViewControllerWithanimationInParent:(id)sender{
    ...
    if ([sender isKindOfClass:[UIButton class]]) {
        ...
        switch (dismissButton.tag) {
            ...
            case MJPopupViewAnimationSlideRightLeft:
            case MJPopupViewAnimationSlideLeftRight:
                [self dismissPopupViewControllerWithanimationTypeInParent:dismissButton.tag];
                break;
            default:
                [self dismissPopupViewControllerWithanimationTypeInParent:MJPopupViewAnimationFade];
                break;
        }
    } else {
        [self dismissPopupViewControllerWithanimationTypeInParent:MJPopupViewAnimationFade];
...
- (void)slideViewIn:(UIView*)popupView sourceView:(UIView*)sourceView overlayView:(UIView*)overlayView withAnimationType:(MJPopupViewAnimation)animationType
{
    ...
    CGRect popupEndRect;
    if (animationType==MJPopupViewAnimationSlideRightLeft) {
