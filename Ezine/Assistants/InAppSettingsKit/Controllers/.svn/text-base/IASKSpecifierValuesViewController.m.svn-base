...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row==0) {
         [[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithInt:0] forKey:@"AppfontSize"];
        XAppDelegate.appFontSize =0;
    }else if (indexPath.row==1) {
        [[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithInt:3] forKey:@"AppfontSize"];
        XAppDelegate.appFontSize =3;
        
    } else if (indexPath.row==2) {
        [[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithInt:5] forKey:@"AppfontSize"];
        XAppDelegate.appFontSize =5;
    }
}
