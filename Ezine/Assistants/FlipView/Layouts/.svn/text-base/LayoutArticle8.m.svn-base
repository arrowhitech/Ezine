...
-(void)initalizeViews:(NSArray*)viewCollectionDictonary{
    for (int i=0; i<[viewCollectionDictonary count]; i++) {
        ...
        if ([articalmode._Zone isEqualToString:@"Zone1"]) {
            ...
            view4 =[[[NewListArticleItemView2 alloc] initWithMessageModel:articalmode andViewoder:4] retain];
...
-(void)rotate:(UIInterfaceOrientation)orientation animation:(BOOL)animation {
	...
	if (orientation == UIInterfaceOrientationPortrait || orientation == UIInterfaceOrientationPortraitUpsideDown) {
		if (view1 != nil) {
            ...
            [view1 setFrame:CGRectMake(-1, spaceHeder-1,768+2,382)];
            [view2 setFrame:CGRectMake(-1, spaceHeder+view1.bounds.size.height-1,768/3.0+2,517+2)];
            [view3 setFrame:CGRectMake(view2.bounds.size.width-1, spaceHeder+view1.bounds.size.height-1,768/3.0+2,517+2)];
            [view4 setFrame:CGRectMake(view2.bounds.size.width-1+view2.bounds.size.width ,view1.bounds.size.height+spaceHeder-1,768/3.0+2,517+2)];
		...
		if (view1 != nil) {
            ...
            [view1 setFrame:CGRectMake(-1, spaceHeder-1, 1024/2.0+2.5, (768-spaceHeder-20-spaceBottom)/2.0+1)];
            [view2 setFrame:CGRectMake(1024/2.0+2, spaceHeder-1, 1024/2.0+2, (768-spaceHeder-20-spaceBottom)/2.0+1)];
            [view3 setFrame:CGRectMake(-1,spaceHeder+(768-spaceHeder-20-spaceBottom)/2.0, 1024/2.0+2.5, (768-spaceHeder-20-spaceBottom)/2.0+1)];
            [view4 setFrame:CGRectMake(1024/2.0+2, spaceHeder+(768-spaceHeder-20-spaceBottom)/2.0, 1024/2.0+2, (768-spaceHeder-20-spaceBottom)/2.0+1)];
            [view1 reAdjustLayout:orientation];
            [view2 reAdjustLayout:orientation];
            [view3 reAdjustLayout:orientation];
            [view4 reAdjustLayout:orientation];
