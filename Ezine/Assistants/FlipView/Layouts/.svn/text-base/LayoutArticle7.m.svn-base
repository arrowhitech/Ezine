...
// Description:3 trái 2 phải (trái/phải =1/1). Trái chia làm 3 phần bằng nhau từ trên xuống dưới đều có ảnh và text, Phải chia làm 2 phần bằng nhau từ trên xuống dưới, trên có text ko có ảnh, dưới có ảnh và text. tất cả đều ko có titleFeed và image icon
...
-(void)initalizeViews:(NSArray*)viewCollectionDictonary{
    for (int i=0; i<[viewCollectionDictonary count]; i++) {
        ...
        if ([articalmode._Zone isEqualToString:@"Zone1"]) {
            ...
            view2 =[[[NewListArticleItemView10 alloc] initWithMessageModel: (ArticleModel*)[viewCollectionDictonary objectAtIndex:i]andViewoder:2] retain];
...
//    
//    view2 =[[[NewListArticleItemView10 alloc] initWithMessageModel: (ArticleModel*)[viewCollectionDictonary objectAtIndex:1]andViewoder:2] retain];
...
-(void)rotate:(UIInterfaceOrientation)orientation animation:(BOOL)animation {
	...
	if (orientation == UIInterfaceOrientationPortrait || orientation == UIInterfaceOrientationPortraitUpsideDown) {
		if (view1 != nil) {
            ...
            [view1 setFrame:CGRectMake(-1, spaceHeder-1,389+2,573)];
            [view2 setFrame:CGRectMake(389,spaceHeder-1,389,573)];
		...
		if (view1 != nil) {		
            ...
            [view1 setFrame:CGRectMake(0, spaceHeder-1,341,643)];
            [view2 setFrame:CGRectMake(341,spaceHeder-1,341,643)];
            [view3 setFrame:CGRectMake(682,spaceHeder-1,342,643)];
