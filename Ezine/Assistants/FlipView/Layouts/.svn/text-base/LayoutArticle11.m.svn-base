...
@implementation LayoutArticle11
@synthesize view1;
@synthesize view2;
@synthesize view3;
...
//    
//    view2 =[[[NewListArticleItemView7 alloc] initWithMessageModel: (ArticleModel*)[viewCollectionDictonary objectAtIndex:1]andViewoder:2] retain];
...
-(void)rotate:(UIInterfaceOrientation)orientation animation:(BOOL)animation {
	...
	if (orientation == UIInterfaceOrientationPortrait || orientation == UIInterfaceOrientationPortraitUpsideDown) {
		if (view1 != nil) {
            ...
            [view1 setFrame:CGRectMake(-1,spaceHeder,768+2,550+spaceHeder)];
            [view2 setFrame:CGRectMake(-1,550+spaceHeder,531+2,348)];
            [view3 setFrame:CGRectMake(531,550+spaceHeder,237,348)];
		...
		if (view1 != nil) {		
            ...
            [view2 setFrame:CGRectMake(0, spaceHeder-1,680,322)];
            [view1 setFrame:CGRectMake(680.5,spaceHeder-1,344,643)];
            [view3 setFrame:CGRectMake(0,321+spaceHeder,680,321)];
