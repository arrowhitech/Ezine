...
@implementation LayoutArticle15
@synthesize view1;
@synthesize view2;
@synthesize view3;
@synthesize view4;
...
-(void)initalizeViews:(NSArray*)viewCollectionDictonary{
    ...
    for (int i=0; i<[viewCollectionDictonary count]; i++) {
        ...
        if ([articalmode._Zone isEqualToString:@"Zone1"]) {
            ...
            view4 =[[[NewListArticleItemView1 alloc] initWithMessageModel:articalmode andViewoder:4] retain];
            
        }else if ([articalmode._Zone isEqualToString:@"Zone5"]){
            view5 =[[[NewListArticleItemView1 alloc] initWithMessageModel:articalmode andViewoder:5] retain];
...
//    view4 =[[[NewListArticleItemView1 alloc] initWithMessageModel: (ArticleModel*)[viewCollectionDictonary objectAtIndex:3]andViewoder:4] retain];
...
-(void)rotate:(UIInterfaceOrientation)orientation animation:(BOOL)animation {
	...
	if (orientation == UIInterfaceOrientationPortrait || orientation == UIInterfaceOrientationPortraitUpsideDown) {
		if (view1 != nil) {
            ...
            [view1 setFrame:CGRectMake(0, spaceHeder-1,384,300)];
            [view4 setFrame:CGRectMake(384,spaceHeder-1,384,575)];
            [view2 setFrame:CGRectMake(0,299+spaceHeder,384,299)];
            [view5 setFrame:CGRectMake(384,574+spaceHeder,384,324)];
            [view3 setFrame:CGRectMake(0,598+spaceHeder,384,300)];
		...
		if (view1 != nil) {		
            ...
            [view4 setFrame:CGRectMake(-1, spaceHeder-1,382+1,643)];
            [view5 setFrame:CGRectMake(382.5,spaceHeder-1,382,299)];
            [view3 setFrame:CGRectMake(764,spaceHeder-1,260,643)];
            [view1 setFrame:CGRectMake(382,298+spaceHeder,382,172)];
            [view2 setFrame:CGRectMake(382,470+spaceHeder,382,172)];
